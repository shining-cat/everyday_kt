...
### sessions presets
  ...
  - [ ] auto-close fab speed dial when session preset has been created (or maybe even when simply opening the dialog)
  ...
  - [ ] add lmanguage setting to allow change without following the OS language
