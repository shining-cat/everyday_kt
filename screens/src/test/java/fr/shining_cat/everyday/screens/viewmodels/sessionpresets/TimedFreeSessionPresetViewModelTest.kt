...
class TimedFreeSessionPresetViewModelTest {
    ...
    private lateinit var timedFreeSessionPresetViewModel: TimedFreeSessionPresetViewModel
    ...
    fun setUp() {
        ...
        timedFreeSessionPresetViewModel = TimedFreeSessionPresetViewModel(
    ...
    fun `test init for creation`() {
        ...
        val newSessionPreset = SessionPreset.TimedFreeSessionPreset(
            id = -1L,
        ...
        Assert.assertEquals(newSessionPreset, timedFreeSessionPresetViewModel.sessionPresetUpdatedLiveData.getValueForTest())
    }

    @Test
    fun `test init for edition`() {
        val inputSessionPreset = SessionPreset.TimedFreeSessionPreset(
            id = 34L,
        ...
        Assert.assertEquals(inputSessionPreset, timedFreeSessionPresetViewModel.sessionPresetUpdatedLiveData.getValueForTest())
    }
    ...
    fun `test verifyPresetValidity`() {
        Assert.assertEquals(true, timedFreeSessionPresetViewModel.verifyPresetValidity())
    }
    ...
    fun `test saveSessionPreset new sessionPreset success`() {
        ...
        runBlocking {
            timedFreeSessionPresetViewModel.saveSessionPreset(inputSessionPreset)
        }

        //checking
        coVerify(exactly = 1) {mockCreateSessionPresetUseCase.execute(inputSessionPreset)}
        Assert.assertEquals(true, timedFreeSessionPresetViewModel.successLiveData.getValueForTest())
    }
    ...
    fun `test saveSessionPreset new sessionPreset failure`() {
        ...
        //checking
        coVerify(exactly = 1) {mockCreateSessionPresetUseCase.execute(inputSessionPreset)}
        Assert.assertEquals("error message", timedFreeSessionPresetViewModel.errorLiveData.getValueForTest())
    }
    ...
    fun `test deleteSessionPreset success`() {
        ...
        runBlocking {
            timedFreeSessionPresetViewModel.deleteSessionPreset(inputSessionPreset)
        }
    ...
    fun `test updatePresetStartAndEndSoundUriString`() {
        ...
        timedFreeSessionPresetViewModel.updatePresetStartAndEndSoundUriString(newStartAndEndSoundUriString)
        val expectedModifiedSessionPreset = SessionPreset.TimedFreeSessionPreset(
            id = -1L,
            startCountdownLength = Constants.DEFAULT_SESSION_COUNTDOWN_MILLIS,
        ...
        //checking
        Assert.assertEquals(expectedModifiedSessionPreset, timedFreeSessionPresetViewModel.sessionPresetUpdatedLiveData.getValueForTest())
    }
    ...
    fun `test updatePresetStartAndEndSoundName`() {
        ...
        timedFreeSessionPresetViewModel.updatePresetStartAndEndSoundName(newStartAndEndSoundName)
        val expectedModifiedSessionPreset = SessionPreset.TimedFreeSessionPreset(
            id = -1L,
            startCountdownLength = Constants.DEFAULT_SESSION_COUNTDOWN_MILLIS,
            startAndEndSoundUriString = deviceDefaultRingtoneUriString,
    ...
    fun `test updatePresetStartCountdownLength`() {
        ...
        timedFreeSessionPresetViewModel.updatePresetStartCountdownLength(newStartCountdownLength)
        val expectedModifiedSessionPreset = SessionPreset.TimedFreeSessionPreset(
            id = -1L,
    ...
    fun `test updatePresetVibration`() {
        ...
        Assert.assertEquals(newSessionPreset, timedFreeSessionPresetViewModel.sessionPresetUpdatedLiveData.getValueForTest())
        //modifying
        timedFreeSessionPresetViewModel.updatePresetVibration(true)
        val expectedModifiedSessionPreset = SessionPreset.TimedFreeSessionPreset(
            id = -1L,
            startCountdownLength = Constants.DEFAULT_SESSION_COUNTDOWN_MILLIS,
            startAndEndSoundUriString = deviceDefaultRingtoneUriString,
    ...
    fun `test updatePresetSessionTypeId`() {
        ...
        timedFreeSessionPresetViewModel.updatePresetSessionTypeId(newSessionTypeId)
        val expectedModifiedSessionPreset = SessionPreset.TimedFreeSessionPreset(
            id = -1L,
            startCountdownLength = Constants.DEFAULT_SESSION_COUNTDOWN_MILLIS,
            startAndEndSoundUriString = deviceDefaultRingtoneUriString,
    ...
    fun `test updatePresetIntermediateIntervalRandom`() {
        ...
        Assert.assertEquals(newSessionPreset, timedFreeSessionPresetViewModel.sessionPresetUpdatedLiveData.getValueForTest())
        //modifying
        timedFreeSessionPresetViewModel.updatePresetIntermediateIntervalRandom(true)
        //checking
        val updatedSessionPreset = SessionPreset.TimedFreeSessionPreset(
            id = -1L,
            startCountdownLength = Constants.DEFAULT_SESSION_COUNTDOWN_MILLIS,
            startAndEndSoundUriString = deviceDefaultRingtoneUriString,
            startAndEndSoundName = deviceDefaultRingtoneName,
        ...
        Assert.assertEquals(updatedSessionPreset, timedFreeSessionPresetViewModel.sessionPresetUpdatedLiveData.getValueForTest())
    }
    ...
    fun `test updatePresetIntermediateIntervalLength`() {
        ...
        val startSessionPreset = SessionPreset.TimedFreeSessionPreset(
            id = -1L,
            startCountdownLength = Constants.DEFAULT_SESSION_COUNTDOWN_MILLIS,
            startAndEndSoundUriString = deviceDefaultRingtoneUriString,
            startAndEndSoundName = deviceDefaultRingtoneName,
        ...
        Assert.assertEquals(startSessionPreset, timedFreeSessionPresetViewModel.sessionPresetUpdatedLiveData.getValueForTest())
        //modifying
        timedFreeSessionPresetViewModel.updatePresetIntermediateIntervalLength(7953L)
        //
        val updatedSessionPreset = SessionPreset.TimedFreeSessionPreset(
            id = -1L,
            startCountdownLength = Constants.DEFAULT_SESSION_COUNTDOWN_MILLIS,
    ...
    fun `test updatePresetIntermediateIntervalSoundUriString`() {
        ...
        Assert.assertEquals(newSessionPreset, timedFreeSessionPresetViewModel.sessionPresetUpdatedLiveData.getValueForTest())
        //modifying
        timedFreeSessionPresetViewModel.updatePresetIntermediateIntervalSoundUriString("another uri string")
        //checking
        val updatedSessionPreset = SessionPreset.TimedFreeSessionPreset(
            id = -1L,
            startCountdownLength = Constants.DEFAULT_SESSION_COUNTDOWN_MILLIS,
    ...
    fun `test updatePresetIntermediateIntervalSoundName`() {
        ...
        Assert.assertEquals(newSessionPreset, timedFreeSessionPresetViewModel.sessionPresetUpdatedLiveData.getValueForTest())
        //modifying
        timedFreeSessionPresetViewModel.updatePresetIntermediateIntervalSoundName("another sound name")
        //checking
        val updatedSessionPreset = SessionPreset.TimedFreeSessionPreset(
            id = -1L,
            startCountdownLength = Constants.DEFAULT_SESSION_COUNTDOWN_MILLIS,
    ...
    fun `test updatePresetDuration changes nothing`() {
        ...
        Assert.assertEquals(newSessionPreset, timedFreeSessionPresetViewModel.sessionPresetUpdatedLiveData.getValueForTest())
        //modifying
        timedFreeSessionPresetViewModel.updatePresetDuration(6789L)
        //checking
        Assert.assertEquals(newSessionPreset, timedFreeSessionPresetViewModel.sessionPresetUpdatedLiveData.getValueForTest())
    }
