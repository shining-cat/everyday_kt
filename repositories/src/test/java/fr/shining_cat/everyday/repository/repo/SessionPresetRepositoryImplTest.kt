...
class SessionPresetRepositoryImplTest {
    ...
    fun setUp() {
        ...
        sessionPresetRepo = SessionPresetRepositoryImpl(
            mockSessionPresetDao, mockSessionPresetConverter, mockLogger
        )
    ...
    fun insert() {
        ...
        val output = runBlocking {
            sessionPresetRepo.insert(
                listOf(
                    mockSessionPreset, mockSessionPreset, mockSessionPreset
                )
            )
        }
    ...
    fun getAllSessionPresetsLastEditTimeDesc() {
        ...
        assertTrue(output is Output.Success)
        assertEquals(
            listOf(mockSessionPreset), (output as Output.Success).result
        )
    }
