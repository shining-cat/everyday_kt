...
class SessionRecordConverterTest {
    ...
    fun convertDTOtoModelToDTO(){
        ...
        val sessionModelTranslated = sessionRecordConverter.convertEntitytoModel(SessionRecordEntity)
        val SessionRecordEntitytranslated = sessionRecordConverter.convertModelToEntity(sessionModelTranslated)
        compareTwoDTOsWithoutId(SessionRecordEntity, SessionRecordEntitytranslated)
    }
    ...
    fun convertModelToDTOToModel(){
        ...
        val SessionRecordEntitytranslated = sessionRecordConverter.convertModelToEntity(sessionModel)
        val sessionModelTranslated = sessionRecordConverter.convertEntitytoModel(SessionRecordEntitytranslated)
        ...
        val SessionRecordEntitytranslatedWithId = sessionRecordConverter.convertModelToEntity(sessionModelWithId)
        val sessionModelTranslatedWithId = sessionRecordConverter.convertEntitytoModel(SessionRecordEntitytranslatedWithId)
