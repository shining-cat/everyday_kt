...
import fr.shining_cat.everyday.BuildConfig
...
val Any.TAG_LOG: String
    get() {
        ...
        return ellipsizeStringFallbackIfNullOrEmpty(tag, MAX_TAG_LENGTH_IN_LOG, NO_JAVACLASS_NAME_TAG_LOG, ANONYMOUS_CLASS_TAG_LOG)
    }


fun Any.logD(message: String, overwriteTag: String? = null, throwable: Throwable? = null){
    if(BuildConfig.DEBUG){
        val actualTag = ellipsizeStringFallbackIfNullOrEmpty(overwriteTag, MAX_TAG_LENGTH_IN_LOG, TAG_LOG, TAG_LOG)
