...
//
//        val rewardEntity = RewardEntityTestUtils.generateReward(desiredId = 25)
...
//        val rewardsToInsertList = RewardEntityTestUtils.generateRewards(20)
...
//        val rewardEntityToDeleteTest = RewardEntityTestUtils.generateReward(desiredId = 25)
//        //
//        checkTotalCountIs(0)
...
//        runBlocking {
//            rewardDao.insert(RewardEntityTestUtils.generateReward(desiredId = 25))
//            rewardDao.insert(RewardEntityTestUtils.generateReward(desiredId = 26))
//            rewardDao.insert(RewardEntityTestUtils.generateReward(desiredId = 27))
//            rewardDao.insert(RewardEntityTestUtils.generateReward(desiredId = 28))
//            rewardDao.insert(RewardEntityTestUtils.generateReward(desiredId = 29))
//            rewardDao.insert(RewardEntityTestUtils.generateReward(desiredId = 30))
//        }
//        val rewardEntityToDeleteTest = RewardEntityTestUtils.generateReward(desiredId = 723)
//        //
//        checkTotalCountIs(6)
//        val countDeleted = runBlocking {
//            rewardDao.deleteReward(rewardEntityToDeleteTest)
...
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(50))
//        runBlocking {
//            rewardDao.insert(rewardsToInsertList)
//        }
...
//        val rewardsToDeleteList = RewardEntityTestUtils.generateRewards(17)
//        checkTotalCountIs(0)
...
//        runBlocking {
//            rewardDao.insert(RewardEntityTestUtils.generateRewards(29))
//        }
...
//        runBlocking {
//            rewardDao.insert(RewardEntityTestUtils.generateRewards(73))
//        }
...
//        val rewardEntity = RewardEntityTestUtils.generateReward(
//                                                desiredLevel = 3,
//                                                active = true,
//                                                escaped = false,
//                                                desiredId = 83,
...
//        //
//        runBlocking {
//            rewardDao.insert(RewardEntityTestUtils.generateRewards(13))
//        }
...
//        checkTotalCountIs(0)
//        val rewardEntityToUpdate = RewardEntityTestUtils.generateReward(desiredId = 73)
...
//
//        runBlocking {
//            rewardDao.insert(RewardEntityTestUtils.generateRewards(53))
//        }
...
//            RewardEntityTestUtils.generateReward(desiredId = 13),
//            RewardEntityTestUtils.generateReward(desiredId = 17),
//            RewardEntityTestUtils.generateReward(desiredId = 23),
//            RewardEntityTestUtils.generateReward(desiredId = 37))
//        val insertedIds = runBlocking {
...
//            RewardEntityTestUtils.generateReward(active = true, yearAcquired = 1987, monthAcquired = 2,dayAcquired = 9),
//            RewardEntityTestUtils.generateReward(active = false, yearAcquired = 1985, monthAcquired = 3,dayAcquired = 11),
//            RewardEntityTestUtils.generateReward(active = true, yearAcquired = 1984, monthAcquired = 4,dayAcquired = 13),
//            RewardEntityTestUtils.generateReward(active = false, yearAcquired = 1983, monthAcquired = 5,dayAcquired = 15),
//            RewardEntityTestUtils.generateReward(active = true, yearAcquired = 1982, monthAcquired = 6,dayAcquired = 17),
//            RewardEntityTestUtils.generateReward(active = true, yearAcquired = 1981, monthAcquired = 7,dayAcquired = 19),
//            RewardEntityTestUtils.generateReward(active = false, yearAcquired = 1980, monthAcquired = 8,dayAcquired = 21)
//        )
//        runBlocking {
//            rewardDao.insert(rewardsToInsertList)
//        }
...
//
//        val rewardsToInsertList = mutableListOf<RewardEntity>()
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(42, desiredLevel = 2, active = true))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(51, desiredLevel = 3, active = true))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(67, desiredLevel = 4, active = true))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(83, desiredLevel = 5, active = true))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(21, desiredLevel = 2, active = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(34, desiredLevel = 3, active = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(47, desiredLevel = 4, active = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(59, desiredLevel = 5, active = false))
//        runBlocking {
//            rewardDao.insert(rewardsToInsertList)
//        }
...
//
//        val rewardsToInsertList = mutableListOf<RewardEntity>()
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(29, desiredLevel = 2, active = true))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(19, desiredLevel = 3, active = true))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(42, desiredLevel = 4, active = true))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(81, desiredLevel = 5, active = true))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(8, desiredLevel = 2, active = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(17, desiredLevel = 3, active = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(38, desiredLevel = 4, active = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(91, desiredLevel = 5, active = false))
//        runBlocking {
//            rewardDao.insert(rewardsToInsertList)
//        }
...
//
//        val rewardsToInsertList = listOf(
//            RewardEntityTestUtils.generateReward(escaped = true, yearAcquired = 1987, monthAcquired = 2,dayAcquired = 9),
//            RewardEntityTestUtils.generateReward(escaped = false, yearAcquired = 1985, monthAcquired = 3,dayAcquired = 11),
//            RewardEntityTestUtils.generateReward(escaped = true, yearAcquired = 1984, monthAcquired = 4,dayAcquired = 13),
//            RewardEntityTestUtils.generateReward(escaped = false, yearAcquired = 1983, monthAcquired = 5,dayAcquired = 15),
//            RewardEntityTestUtils.generateReward(escaped = true, yearAcquired = 1982, monthAcquired = 6,dayAcquired = 17),
//            RewardEntityTestUtils.generateReward(escaped = true, yearAcquired = 1981, monthAcquired = 7,dayAcquired = 19),
//            RewardEntityTestUtils.generateReward(escaped = false, yearAcquired = 1980, monthAcquired = 8,dayAcquired = 21)
//        )
//        runBlocking {
//            rewardDao.insert(rewardsToInsertList)
//        }
...
//
//        val rewardsToInsertList = mutableListOf<RewardEntity>()
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(5, 3, active = false, escaped = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(3, 3, active = true, escaped = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(3, 3, active = true, escaped = true))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(6, 4, active = false, escaped = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(7, 4, active = true, escaped = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(7, 4, active = true, escaped = true))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(2, 5, active = true, escaped = true))
//        //
//        runBlocking {
//            rewardDao.insert(rewardsToInsertList)
//        }
...
//        val rewardsToInsertList = mutableListOf<RewardEntity>()
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(5, 3, active = false, escaped = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(7, 3, active = true, escaped = true))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(6, 4, active = false, escaped = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(3, 4, active = true, escaped = true))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(8, 4, active = true, escaped = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(9, 3, active = true, escaped = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(2, 5, active = true, escaped = false))
//        //
//        runBlocking {
//            rewardDao.insert(rewardsToInsertList)
//        }
...
//
//        runBlocking {
//            rewardDao.insert(RewardEntityTestUtils.generateRewards(125))
//        }
...
//
//        val rewardsToInsertList = mutableListOf<RewardEntity>()
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(3, 1, active = true, escaped = true))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(5, 3, active = true, escaped = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(7, 3, active = true, escaped = true))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(9, 5, active = true, escaped = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(13, 5, active = true, escaped = true))
//
//        runBlocking {
//            rewardDao.insert(rewardsToInsertList)
//        }
...
//
//        val rewardsToInsertList = mutableListOf<RewardEntity>()
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(3, 1, active = true, escaped = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(5, 3, active = true, escaped = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(7, 3, active = true, escaped = true))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(9, 5, active = true, escaped = false))
//        rewardsToInsertList.addAll(RewardEntityTestUtils.generateRewards(13, 5, active = true, escaped = true))
